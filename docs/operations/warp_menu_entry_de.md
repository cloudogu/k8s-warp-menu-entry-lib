...
| `category` | ja | 1–50 Zeichen | Kategorie unter der der Eintrag im Warp-Menü sichtbar wird. Wird die Kategorie neu erstellt, wird sie am Ende des Warp-Menüs angezeigt | 
